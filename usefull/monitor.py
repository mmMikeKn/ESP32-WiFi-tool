...
class Monitor(object):
    ...
    """
    def __init__(self, serial_instance, print_filter, make="make", toolchain_prefix=DEFAULT_TOOLCHAIN_PREFIX, eol="CRLF"):
...
def main():
    ...
    monitor = Monitor(serial_instance, args.print_filter, args.make, args.toolchain_prefix, args.eol)
